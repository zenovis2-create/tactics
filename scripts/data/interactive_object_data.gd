...
@export_enum("chest", "lever", "door", "gate", "altar", "gate_control", "well", "battery", "shrine", "floodgate", "evidence", "bell", "chain_control", "keeper_lectern", "route_marker", "latch") var object_type: String = "chest"

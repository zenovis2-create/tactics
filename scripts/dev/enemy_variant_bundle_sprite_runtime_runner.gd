...
const UNITS := [
	{
		...
		"data": preload("res://data/units/enemy_lete_ch08_05.tres"),
		"aliases": ["enemy_lete"],
	},
	{
		"label": "Final Karuon",
		"unit_id": "enemy_karuon_final",
		"anchor": "sprite_anchor_enemy_karuon_final",
		"data": preload("res://data/units/enemy_karuon_final.tres"),
...
func _run() -> void:
	...
	print("[PASS] enemy_variant_bundle_sprite_runtime_runner validated Enemy Lete/Final Karuon prototype v02.1 sprite runtimes.")
	quit(0)

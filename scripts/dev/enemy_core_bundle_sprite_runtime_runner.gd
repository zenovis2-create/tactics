...
const UNITS := [
	{
		"label": "Barten",
		"unit_id": "enemy_barten",
		"anchor": "sprite_anchor_enemy_barten",
		"data": preload("res://data/units/enemy_barten.tres"),
		"aliases": ["enemy_barten", "enemy_varten"],
	},
	{
		"label": "Varten",
		"unit_id": "enemy_varten",
		"anchor": "sprite_anchor_enemy_barten",
		"data": preload("res://data/units/enemy_varten.tres"),
		"aliases": ["enemy_varten"],
	},
	{
		"label": "Hardren Captain",
		"unit_id": "enemy_hardren_captain",
		"anchor": "sprite_anchor_enemy_hardren_captain",
		"data": preload("res://data/units/enemy_hardren_captain_ch02_05.tres"),
		"aliases": ["enemy_hardren_captain", "Hardren Captain"],
	},
	{
		"label": "Roderic",
		"unit_id": "enemy_roderic",
		"anchor": "sprite_anchor_enemy_roderic",
		"data": preload("res://data/units/enemy_roderic.tres"),
		"aliases": ["enemy_roderic", "Roderic"],
	},
]
...
func _run() -> void:
	...
	print("[PASS] enemy_core_bundle_sprite_runtime_runner validated Barten/Hardren Captain/Roderic prototype v02.1 sprite runtimes.")
	quit(0)

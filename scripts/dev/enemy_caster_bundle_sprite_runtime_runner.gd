...
const UNITS := [
	{
		...
		"data": preload("res://data/units/enemy_hes.tres"),
		"aliases": ["enemy_hes", "Hes"],
	},
	{
		"label": "Resin Warden",
		"unit_id": "enemy_resin_warden",
		"display_name": "Resin Warden",
		"anchor": "sprite_anchor_enemy_resin_warden",
		"data": preload("res://data/units/enemy_resin_warden_ch03_05.tres"),
		"aliases": ["enemy_resin_warden", "Resin Warden"],
	},
	{
		"label": "Ash Archivist",
		"unit_id": "enemy_ash_archivist",
		"display_name": "Ash Archivist",
		"anchor": "sprite_anchor_enemy_ash_archivist",
		"data": preload("res://data/units/enemy_ash_archivist_ch05_05.tres"),
		"aliases": ["enemy_ash_archivist", "Ash Archivist"],
	},
]
...
func _run() -> void:
	...
	print("[PASS] enemy_caster_bundle_sprite_runtime_runner validated Hes/Resin Warden/Ash Archivist prototype v02.1 sprite runtimes.")
	quit(0)

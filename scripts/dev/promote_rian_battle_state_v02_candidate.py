...
ROOT = Path("/Volumes/AI/tactics/assets/characters/sprite_anchor_rian")
FRAME_W = 256
FRAME_H = 256
FRAMES = [(0, 0), (1, 0), (2, 0), (3, 0), (4, 0), (0, 1), (1, 1), (2, 1)]
STATES = {
    "idle": "rian_idle_sheet_source_v02_layered.png",
    "move": "rian_move_sheet_source_v02_layered.png",
    "attack": "rian_attack_sheet_source_v02_layered.png",
}
...
def export_state(state: str, source_name: str) -> None:
    ...
    for frame_index, (cell_x, cell_y) in enumerate(FRAMES):
        ...
        out_path = out_dir / f"rian_{state}_{frame_index:02d}.png"
        frame.save(out_path)
        print(out_path)

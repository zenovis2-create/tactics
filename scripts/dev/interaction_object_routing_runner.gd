...
func _run() -> void:
	...
	if altar == null or lever == null or gate_control == null or well == null or battery == null or shrine == null or floodgate == null or evidence == null or bell == null or chain_control == null or keeper_lectern == null or route_marker == null or latch == null:
	...
	print("[PASS] interaction_object_routing_runner validated altar/lever/gate-control/well/battery/shrine/floodgate/evidence/bell/chain_control/keeper_lectern/route_marker/latch runtime routing.")
	quit(0)

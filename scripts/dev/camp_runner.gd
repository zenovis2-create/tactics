...
func _assert_summary_keys(ctrl: CampController) -> bool:
    ...
    for key: String in ["chapter", "burden", "trust", "ending_tendency", "narrative_axis_entries", "recovered_fragments", "unlocked_commands", "unlocked_axes", "pending_notifications", "has_new_records", "memory_entries", "evidence_entries", "letter_entries", "unit_progression_summary"]:

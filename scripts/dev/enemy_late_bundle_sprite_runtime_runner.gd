...
const UNITS := [
	{
		"label": "Valgar",
		"unit_id": "enemy_valgar",
		"anchor": "sprite_anchor_enemy_valgar",
		"data": preload("res://data/units/enemy_valgar.tres"),
		"aliases": ["enemy_valgar", "Valgar"],
	},
	{
		"label": "Enemy Melkion",
		"unit_id": "enemy_melkion",
		"anchor": "sprite_anchor_enemy_melkion",
		"data": preload("res://data/units/enemy_melkion_ch09b_05.tres"),
		"aliases": ["enemy_melkion"],
	},
	{
		"label": "Enemy Kyle",
		"unit_id": "enemy_kyle_1",
		"anchor": "sprite_anchor_enemy_kyle",
		"data": preload("res://data/units/enemy_kyle_ch09a_05.tres"),
...
func _run() -> void:
	...
	print("[PASS] enemy_late_bundle_sprite_runtime_runner validated Valgar/Melkion/Kyle prototype v02.1 sprite runtimes.")
	quit(0)

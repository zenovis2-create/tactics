...
This folder is the production workspace for the baseline hostile melee infantry sprite anchor.

## Pipeline

1. `spec.md`
   Production source of truth.
2. `prompt_pack_v01.md`
   First generation prompt set.
3. Future `source/`
   Chosen generated sheets.
4. Future `clean/`
   Krita-cleaned source sheets.
5. Future `runtime/`
   Godot-ready frame exports.
